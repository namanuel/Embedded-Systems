...
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabn	162,0,0,0
	.stabs	"__vector_16:F(0,47)",36,0,18,__vector_16
.global	__vector_16
...
.LM6:
	...
	cpi r24,lo8(9)
	brlo .L1
	.stabn	68,0,29,.LM7-.LFBB1
.LM7:
	sts count.1662,__zero_reg__
.L1:
/* epilogue start */
	.stabn	68,0,31,.LM8-.LFBB1
.LM8:
	pop r25
	pop r24
	pop r0
	...
	.stabs	"count:V(5,2)",38,0,20,count.1662
...
.LM15:
	movw r24,r28
	adiw r24,1
	call uart_receive_nb
	.stabn	68,0,44,.LM16-.LFBB2
.LM16:
	tst r24
	breq .L8
...
brightness:
	.byte	1
	.stabs	"brightness:G(0,48)=B(5,2)",32,0,16,0
	.text
